...
No dedicated public security email is currently listed for this project.
Use GitHub private vulnerability reporting if it is enabled for the repository, or contact one of the maintainers listed in `README.md` through a private channel.
If no private channel is available, ask a maintainer for the reporting route without posting exploit details publicly.
...
If encrypted reporting is later supported, document key-sharing instructions in this section.

## Sensitive Data Areas

Treat these product areas as security-sensitive:

- user accounts, passwords, roles, addresses, phone numbers, and profile details
- allergy declarations and allergen matching
